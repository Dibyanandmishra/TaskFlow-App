  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[var(--color-background)] px-4 py-12">
      ...
      <div className="w-full max-w-md bg-[var(--color-card)] rounded-2xl border border-[var(--color-border)] p-8 sm:p-10 shadow-sm">
        <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-2 text-center tracking-tight">Create an account</h2>
        <p className="text-sm text-[var(--color-text-secondary)] text-center mb-8">Start managing your tasks today</p>
        ...
        <p className="mt-8 text-center text-sm text-[var(--color-text-secondary)]">
          ...
          <Link to="/login" className="text-[var(--color-primary)] hover:text-[var(--color-primary-hover)] font-medium transition-colors focus-ring rounded px-1">
            Sign In
          </Link>
        </p>
      </div>
